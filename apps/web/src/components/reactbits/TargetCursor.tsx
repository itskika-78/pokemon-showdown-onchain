...
export const CURSOR_TARGET_SELECTOR =
  'a, button, [role="button"], .btn, .card.click, .move-btn, .switch-btn, .net-card, .segmented button, .cursor-target, .navlink, .bottom-nav-link, .pp-btn, .tp-mon.click, .pc-contact-btn, label.switch, .pokeball-btn';
...
const TargetCursor = ({
  targetSelector = CURSOR_TARGET_SELECTOR,
  spinDuration = 2,
